...
export async function proxy(request: NextRequest) {
  ...
  if (
    ...
    if (localeContext) {
      ...
      if (segments[1] === 'vehicle-news' || segments[1] === 'fordonsnyheter' || segments[1] === 'sell-vehicle' || segments[1] === 'benefits' || segments[1] === 'sell-car' || LOCALIZED_AD_SEGMENTS.has(segments[1] || '')) {
