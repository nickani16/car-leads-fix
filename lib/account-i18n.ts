...
const en: AccountCopy = {
  ...
  registerDescription: 'Create a private or business account to publish listings, save searches and contact sellers securely across Europe. Private sellers normally show only their first name publicly; full names stay internal for account, safety and legal handling.',
