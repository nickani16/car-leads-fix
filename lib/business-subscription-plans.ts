...
const businessSubscriptionCopyByLocale: Partial<Record<PublicLocale, Partial<BusinessSubscriptionCopy>>> = {
  sv: {
    ...
    paymentTerms: 'Betalningsvillkor: 30 dagar.',
  ...
  es: {
    ...
    paymentTerms: 'Condiciones de pago: 30 días.',
  ...
  nl: {
    ...
    paymentTerms: 'Betalingstermijn: 30 dagen.',
    ...
    paymentTerms: 'Maksuehto: 30 päivää.',
  ...
  da: {
    ...
    paymentTerms: 'Betalingsbetingelser: 30 dage.',
  ...
  pl: {
    ...
    paymentTerms: 'Termin płatności: 30 dni.',
