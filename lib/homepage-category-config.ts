...
const vehicleTypeLabels: Record<string, Label> = {
  ...
  'Crew van': label('Dubbelhytt', 'Crew van', 'Doppelkabine', 'Cabine approfondie', 'Doble cabina', 'Doppia cabina', 'Brygadówka', 'Dubbele cabine', 'Miehistöpakettiauto', 'Dobbeltkabine'),
  'Box van': label('Volymskåp', 'Box van', 'Kofferwagen', 'Fourgon caisse', 'Furgón caja', 'Furgone cassonato', 'Furgon kontener', 'Bakwagen', 'Umpikorinen pakettiauto', 'Kassebil'),
...
const homepageCategoryDefinitions: Record<MarketplaceCategorySlug, HomepageCategoryDefinition> = {
  cars: {
    types: [
      type('hatchback', 'Halvkombi', '/homepage-discovery/types/cars-hatchback.webp'),
      type('sedan', 'Sedan', '/homepage-discovery/types/cars-sedan.webp'),
      type('suv', 'SUV', '/homepage-discovery/types/cars-suv.webp'),
    ...
    sellImage: '/homepage-discovery/sell/cars.webp',
  },
  vans: {
    types: [
      type('panel', 'Skåpbil', '/homepage-discovery/types/vans-panel.webp'),
      type('crew', 'Crew van', '/homepage-discovery/types/vans-crew.webp'),
      type('box', 'Box van', '/homepage-discovery/types/vans-box.webp'),
      type('refrigerated', 'Kylbil', '/homepage-discovery/types/vans-refrigerated.webp'),
      type('minibus', 'Minibuss', '/homepage-discovery/types/vans-minibus.webp'),
      type('flatbed', 'Flak', '/homepage-discovery/types/vans-flatbed.webp'),
      type('pickup', 'Pickup', '/homepage-discovery/types/vans-pickup.webp'),
      type('chassis', 'Chassi', '/homepage-discovery/types/vans-chassis.webp'),
      type('electric', 'Eltransport', '/homepage-discovery/types/vans-electric.webp'),
    ],
  ...
  trucks: {
    types: [
      type('tractor-unit', 'Dragbil', '/homepage-discovery/types/trucks-tractor-unit.webp'),
      type('box', 'Skåp', '/homepage-discovery/types/trucks-box.webp'),
      type('flatbed', 'Flak', '/homepage-discovery/types/trucks-flatbed.webp'),
      type('tipper', 'Tipp', '/homepage-discovery/types/trucks-tipper.webp'),
      type('crane', 'Kranbil', '/homepage-discovery/types/trucks-crane.webp'),
      type('tanker', 'Tankbil', '/homepage-discovery/types/trucks-tanker.webp'),
      type('refrigerated', 'Kylbil', '/homepage-discovery/types/trucks-refrigerated.webp'),
      type('chassis', 'Chassi', '/homepage-discovery/types/trucks-chassis.webp'),
      type('hook-lift', 'Lastväxlare', '/homepage-discovery/types/trucks-hook-lift.webp'),
      type('concrete-mixer', 'Betongbil', '/homepage-discovery/types/trucks-concrete-mixer.webp'),
      type('bus', 'Buss', '/homepage-discovery/types/trucks-bus.webp'),
    ],
    ...
    sellImage: '/homepage-discovery/sell/trucks.webp',
  },
  motorcycles: {
    types: [
      type('sport', 'Sport', '/homepage-discovery/types/motorcycles-sport.webp'),
      type('touring', 'Touring', '/homepage-discovery/types/motorcycles-touring.webp'),
      type('custom', 'Custom', '/homepage-discovery/types/motorcycles-cruiser.webp'),
      type('scooter', 'Scooter', '/homepage-discovery/types/motorcycles-scooter.webp'),
      type('cross-enduro', 'Cross / enduro', '/homepage-discovery/types/motorcycles-enduro.webp'),
      type('adventure', 'Adventure', '/homepage-discovery/types/motorcycles-adventure.webp'),
      type('naked', 'Naked', '/homepage-discovery/types/motorcycles-naked.webp'),
      type('moped', 'Moped', '/homepage-discovery/types/motorcycles-moped.webp'),
      type('atv', 'ATV', '/homepage-discovery/types/motorcycles-atv.webp'),
    ],
    ...
    sellImage: '/homepage-discovery/sell/motorcycles.webp',
  },
  construction: {
    types: [
      type('excavator', 'Grävmaskin', '/homepage-discovery/types/construction-excavator.webp'),
      type('mini-excavator', 'Minigrävare', '/homepage-discovery/types/construction-mini-excavator.webp'),
      type('wheel-loader', 'Hjullastare', '/homepage-discovery/types/construction-wheel-loader.webp'),
      type('dumper', 'Dumper', '/homepage-discovery/types/construction-dumper.webp'),
      type('dozer', 'Dozer', '/homepage-discovery/types/construction-bulldozer.webp'),
      type('crane', 'Kran', '/homepage-discovery/types/construction-crane.webp'),
      type('roller', 'Vält', '/homepage-discovery/types/construction-roller.webp'),
      type('lift', 'Lift', '/homepage-discovery/types/construction-lift.webp'),
      type('compactor', 'Kompaktor', '/homepage-discovery/types/construction-compactor.webp'),
    ],
    ...
    sellImage: '/homepage-discovery/sell/construction.webp',
  },
  motorhomes: {
    ...
    sellImage: '/homepage-discovery/sell/motorhomes.webp',
  },
  caravans: {
    types: caravanTypes(),
    ...
    sellImage: '/homepage-discovery/sell/caravans.webp',
  },
  agriculture: {
    types: [
      type('tractor', 'Traktor', '/homepage-discovery/types/agriculture-tractor.webp'),
      type('combine', 'Skördetröska', '/homepage-discovery/types/agriculture-combine.webp'),
      type('implement', 'Redskap', '/homepage-discovery/types/agriculture-implement.webp'),
      type('baler', 'Press', '/homepage-discovery/types/agriculture-baler.webp'),
      type('sprayer', 'Spruta', '/homepage-discovery/types/agriculture-sprayer.webp'),
      type('loader', 'Lastare', '/homepage-discovery/types/agriculture-loader.webp'),
      type('trailer', 'Vagn', '/homepage-discovery/types/agriculture-trailer.webp'),
    ],
    ...
    sellImage: '/homepage-discovery/sell/agriculture.webp',
  },
  'electric-bikes': {
    types: [
      type('city', 'City', '/homepage-discovery/types/electric-bikes-city.webp'),
      type('hybrid', 'Hybrid', '/homepage-discovery/types/electric-bikes-hybrid.webp'),
      type('mountain', 'Mountainbike', '/homepage-discovery/types/electric-bikes-mountain.webp'),
      type('cargo', 'Cargo', '/homepage-discovery/types/electric-bikes-cargo.webp'),
      type('folding', 'Folding', '/homepage-discovery/types/electric-bikes-folding.webp'),
      type('speed', 'Speedbike', '/homepage-discovery/types/electric-bikes-speed.webp'),
      type('racer', 'Racer', '/homepage-discovery/types/electric-bikes-road.webp'),
      type('kids', 'Barncykel', '/homepage-discovery/types/electric-bikes-kids.webp'),
    ],
    ...
    sellImage: '/homepage-discovery/sell/electric-bikes.webp',
  },
}

function motorhomeTypes(): HomepageTypeDefinition[] {
  return [
    type('integrated', 'Helintegrerad', '/homepage-discovery/types/motorhomes-integrated.webp'),
    type('semi-integrated', 'Halvintegrerad', '/homepage-discovery/types/motorhomes-semi-integrated.webp'),
    type('overcab', 'Alkov', '/homepage-discovery/types/motorhomes-overcab.webp'),
    type('camper-van', 'Camper van', '/homepage-discovery/types/motorhomes-camper-van.webp'),
    type('panel-van', 'Plåtis', '/homepage-discovery/types/motorhomes-panel-van.webp'),
  ]
}

function caravanTypes(): HomepageTypeDefinition[] {
  return [
    type('single-axle', 'Enkelaxel', '/homepage-discovery/types/caravans-single.webp'),
    type('twin-axle', 'Boggie', '/homepage-discovery/types/caravans-twin.webp'),
    type('family', 'Familjevagn', '/homepage-discovery/types/caravans-family.webp'),
    type('winter', 'Vintervagn', '/homepage-discovery/types/caravans-winter.webp'),
    type('compact', 'Liten husvagn', '/homepage-discovery/types/caravans-compact.webp'),
  ]
}
