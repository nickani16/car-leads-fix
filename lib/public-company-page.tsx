              ...
              <form action={localizePublicHref(locale, `/company/${data.profile.user_id}`)} className="flex min-w-0 gap-2">
                ...
                <label className="relative min-w-0 flex-1 lg:w-[320px]">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-[10px] border border-[#d9e2ef] bg-white pl-10 pr-3 text-sm font-medium outline-none transition focus:border-[#0866ff] focus:ring-4 focus:ring-[#0866ff]/10"
                  />
                </label>
