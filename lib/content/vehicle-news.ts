...
const fallbackArticles: PublicNewsArticle[] = [
  {
    id: 'fallback-create-free-vehicle-listing',
    slug: 'create-free-vehicle-listing',
    title: 'Skapa en fordonsannons gratis: betala bara när du vill synas längre',
    excerpt: 'Autorell gör det enkelt att komma igång. Publicera gratis, fyll i fordonets viktigaste uppgifter och välj extra synlighet först när du behöver det.',
    body: articleDoc([
      ['heading', 2, 'En enklare start för dig som vill sälja fordon'],
      ['paragraph', 1, 'Att sälja ett fordon ska inte börja med krångel, bindningstid eller dolda avgifter. På Autorell kan privatpersoner skapa en fordonsannons gratis och komma igång på några minuter. Du fyller i de viktigaste uppgifterna, laddar upp tydliga bilder och publicerar annonsen när allt känns rätt.'],
      ['paragraph', 1, 'Grundtanken är enkel: alla ska kunna testa Autorell och få ut sitt fordon på marknaden utan att behöva betala direkt. Det gör tröskeln lägre för privatpersoner som vill sälja bil, motorcykel, husbil, husvagn eller andra fordon på ett mer strukturerat sätt.'],
      ['heading', 2, 'Betala bara om du vill annonsera längre'],
      ['paragraph', 1, 'Den kostnadsfria annonsen är byggd för att hjälpa dig komma igång snabbt. Om du vill låta annonsen ligga ute längre eller ge den mer synlighet kan du välja ett betalt paket. Då betalar du för extra tid och exponering, inte för att få vara med från början.'],
      ['paragraph', 1, 'Det gör prissättningen tydlig och lätt att förstå. Du kan börja gratis, se hur annonsen fungerar och först därefter välja om du vill uppgradera. För många säljare räcker det kostnadsfria alternativet, medan andra vill ha längre annonstid när fordonet kräver mer tid på marknaden.'],
      ['heading', 2, 'Byggd för mobil från första steget'],
      ['paragraph', 1, 'Många skapar sin annons direkt från mobilen. Därför är Autorells annonsflöde uppbyggt steg för steg: kategori och grundinfo först, sedan tekniska detaljer, bilder, förhandsvisning och publicering. Det ska kännas lugnt, tydligt och lätt att fortsätta även på en mindre skärm.'],
      ['paragraph', 1, 'Ju bättre annonsen är strukturerad, desto enklare blir det för köpare att hitta rätt fordon. Märke, modell, plats, pris, årsmodell och tydliga bilder gör annonsen mer sökbar och mer seriös.'],
      ['heading', 2, 'Gratis där det ska vara gratis'],
      ['paragraph', 1, 'Autorells mål är att göra fordonsförsäljning mer transparent. Privatpersoner ska kunna komma igång utan startkostnad, och betalning ska vara ett aktivt val när säljaren vill ha mer tid eller bättre synlighet. Enkelt, tydligt och byggt för moderna fordonsannonser.'],
    ]),
    ...
    tags: ['Gratis annons', 'Sälja fordon', 'Privatförsäljning', 'Autorell'],
    imageUrl: '/autorell-news-free-listing-mobile.jpg',
    imageAlt: 'Autorells annonsflöde visas på en iPhone',
    imageCaption: null,
    seoTitle: 'Skapa fordonsannons gratis | Sälj fordon på Autorell',
    metaDescription: 'Skapa en fordonsannons gratis på Autorell. Betala bara om du vill annonsera längre eller ge annonsen extra synlighet.',
    canonicalUrl: null,
    viewCount: 0,
    relatedPostIds: [],
  },
...
const fallbackTranslations: Record<string, Record<VehicleNewsLanguage, FallbackArticleTranslation>> = {
  'create-free-vehicle-listing': {
    sv: {
      title: 'Skapa en fordonsannons gratis: betala bara när du vill synas längre',
      excerpt: 'Autorell gör det enkelt att komma igång. Publicera gratis och välj extra synlighet först när du behöver det.',
      body: [
        ['heading', 2, 'En enklare start för dig som vill sälja fordon'],
        ['paragraph', 1, 'Att sälja ett fordon ska inte börja med krångel, bindningstid eller dolda avgifter. På Autorell kan privatpersoner skapa en fordonsannons gratis och komma igång på några minuter.'],
        ['paragraph', 1, 'Fyll i de viktigaste uppgifterna, ladda upp tydliga bilder och publicera när allt känns rätt. Det gör tröskeln lägre för dig som vill sälja bil, motorcykel, husbil, husvagn eller andra fordon.'],
        ['heading', 2, 'Betala bara om du vill annonsera längre'],
        ['paragraph', 1, 'Den kostnadsfria annonsen hjälper dig komma igång snabbt. Om du vill låta annonsen ligga ute längre eller ge den mer synlighet kan du välja ett betalt paket.'],
        ['paragraph', 1, 'Du betalar alltså för extra tid och exponering, inte för att få vara med från början. Det gör upplägget tydligt och lätt att förstå.'],
        ['heading', 2, 'Byggd för mobil från första steget'],
        ['paragraph', 1, 'Autorells annonsflöde är uppbyggt steg för steg: kategori, grundinfo, tekniska detaljer, bilder, förhandsvisning och publicering. Det ska kännas tydligt även på mobilen.'],
        ['paragraph', 1, 'Märke, modell, plats, pris och tydliga bilder gör annonsen mer sökbar och mer seriös för köparen.'],
      ],
      tags: ['Gratis annons', 'Sälja fordon', 'Privatförsäljning', 'Autorell'],
      imageAlt: 'Autorells annonsflöde visas på en iPhone',
      seoTitle: 'Skapa fordonsannons gratis | Sälj fordon på Autorell',
    ...
    en: {
      title: 'Create a vehicle listing for free: pay only when you want more time',
      excerpt: 'Autorell makes it easy to get started. Publish for free and choose extra visibility only when you need it.',
      body: [
        ['heading', 2, 'A simpler start when you want to sell a vehicle'],
        ['paragraph', 1, 'Selling a vehicle should not begin with friction, lock-ins or hidden fees. On Autorell, private sellers can create a vehicle listing for free and get started in minutes.'],
        ['paragraph', 1, 'Add the key details, upload clear photos and publish when everything looks right. The flow is designed for cars, motorcycles, motorhomes, caravans and other vehicles.'],
        ['heading', 2, 'Pay only if you want to advertise for longer'],
        ['paragraph', 1, 'The free listing helps you get started quickly. If you want the listing to stay online longer or receive more visibility, you can choose a paid package.'],
        ['paragraph', 1, 'You pay for extra time and exposure, not simply to be present on the marketplace. That keeps the model clear and easy to understand.'],
        ['heading', 2, 'Built for mobile from the first step'],
        ['paragraph', 1, 'Autorell guides you through category, basic details, technical information, images, preview and publishing. It is designed to feel clear even on a smaller screen.'],
        ['paragraph', 1, 'Make, model, location, price and clear images help buyers find and trust your listing.'],
      ],
      tags: ['Free listing', 'Sell vehicle', 'Private seller', 'Autorell'],
      imageAlt: 'Autorell listing flow shown on an iPhone',
      seoTitle: 'Create a free vehicle listing | Sell vehicles on Autorell',
      metaDescription: 'Create a vehicle listing for free on Autorell. Pay only when you want more time or extra visibility.',
    },
    de: {
      title: 'Fahrzeug kostenlos inserieren: nur für längere Laufzeit bezahlen',
      excerpt: 'Mit Autorell starten Sie einfach. Kostenlos veröffentlichen und zusätzliche Sichtbarkeit erst wählen, wenn sie gebraucht wird.',
      body: [
        ['heading', 2, 'Ein einfacher Start für den Fahrzeugverkauf'],
        ['paragraph', 1, 'Ein Fahrzeugverkauf sollte nicht mit Aufwand, Bindung oder versteckten Gebühren beginnen. Auf Autorell können private Verkäufer kostenlos inserieren und in wenigen Minuten starten.'],
        ['paragraph', 1, 'Tragen Sie die wichtigsten Daten ein, laden Sie klare Bilder hoch und veröffentlichen Sie die Anzeige, wenn alles passt.'],
        ['heading', 2, 'Nur bezahlen, wenn die Anzeige länger laufen soll'],
        ['paragraph', 1, 'Die kostenlose Anzeige hilft beim schnellen Start. Wer mehr Laufzeit oder mehr Sichtbarkeit möchte, kann ein kostenpflichtiges Paket wählen.'],
        ['paragraph', 1, 'Bezahlt wird für zusätzliche Zeit und Reichweite, nicht dafür, überhaupt gelistet zu sein. Das macht das Modell transparent.'],
        ['heading', 2, 'Von Anfang an mobil gedacht'],
        ['paragraph', 1, 'Der Anzeigenfluss führt Schritt für Schritt durch Kategorie, Grunddaten, technische Details, Bilder, Vorschau und Veröffentlichung.'],
        ['paragraph', 1, 'Marke, Modell, Standort, Preis und klare Bilder machen die Anzeige besser auffindbar und seriöser.'],
      ],
      tags: ['Kostenlose Anzeige', 'Fahrzeug verkaufen', 'Privatverkauf', 'Autorell'],
      imageAlt: 'Autorell-Anzeigenfluss auf einem iPhone',
      seoTitle: 'Fahrzeug kostenlos inserieren | Verkaufen auf Autorell',
      metaDescription: 'Erstellen Sie kostenlos eine Fahrzeuganzeige auf Autorell. Zahlen Sie nur für längere Laufzeit oder zusätzliche Sichtbarkeit.',
    },
    fr: {
      title: 'Créer une annonce véhicule gratuite : payez seulement pour plus de durée',
      excerpt: 'Autorell facilite le démarrage. Publiez gratuitement et ajoutez de la visibilité uniquement si nécessaire.',
      body: [
        ['heading', 2, 'Un départ plus simple pour vendre un véhicule'],
        ['paragraph', 1, 'Vendre un véhicule ne doit pas commencer par des frais cachés ou un processus compliqué. Sur Autorell, les particuliers peuvent créer une annonce gratuite en quelques minutes.'],
        ['paragraph', 1, 'Ajoutez les informations essentielles, des photos claires et publiez quand tout est prêt.'],
        ['heading', 2, 'Payez seulement pour annoncer plus longtemps'],
        ['paragraph', 1, 'L’annonce gratuite permet de commencer rapidement. Pour une durée plus longue ou plus de visibilité, vous pouvez choisir une option payante.'],
        ['paragraph', 1, 'Vous payez pour du temps et de l’exposition supplémentaires, pas pour accéder au marché.'],
        ['heading', 2, 'Pensé pour le mobile'],
        ['paragraph', 1, 'Autorell guide la création étape par étape : catégorie, informations de base, détails techniques, images, aperçu et publication.'],
        ['paragraph', 1, 'Marque, modèle, lieu, prix et bonnes photos rendent l’annonce plus facile à trouver et plus fiable.'],
      ],
      tags: ['Annonce gratuite', 'Vendre un véhicule', 'Particulier', 'Autorell'],
      imageAlt: 'Le flux de création d’annonce Autorell sur un iPhone',
      seoTitle: 'Créer une annonce véhicule gratuite | Vendre sur Autorell',
      metaDescription: 'Créez une annonce véhicule gratuite sur Autorell. Payez seulement pour prolonger l’annonce ou gagner en visibilité.',
    },
    es: {
      title: 'Crea un anuncio de vehículo gratis: paga solo si quieres más tiempo',
      excerpt: 'Autorell facilita el inicio. Publica gratis y añade más visibilidad solo cuando la necesites.',
      body: [
        ['heading', 2, 'Un inicio más sencillo para vender un vehículo'],
        ['paragraph', 1, 'Vender un vehículo no debería empezar con complicaciones, permanencias ni costes ocultos. En Autorell, los particulares pueden crear un anuncio gratis en pocos minutos.'],
        ['paragraph', 1, 'Añade los datos clave, sube fotos claras y publica cuando todo esté listo.'],
        ['heading', 2, 'Paga solo si quieres anunciar durante más tiempo'],
        ['paragraph', 1, 'El anuncio gratuito te ayuda a empezar rápido. Si quieres más duración o más visibilidad, puedes elegir un paquete de pago.'],
        ['paragraph', 1, 'Pagas por tiempo y exposición adicionales, no por estar presente desde el principio.'],
        ['heading', 2, 'Diseñado para móvil desde el primer paso'],
        ['paragraph', 1, 'Autorell guía el proceso por categoría, datos básicos, detalles técnicos, imágenes, vista previa y publicación.'],
        ['paragraph', 1, 'Marca, modelo, ubicación, precio y buenas fotos hacen que el anuncio sea más fácil de encontrar y más fiable.'],
      ],
      tags: ['Anuncio gratis', 'Vender vehículo', 'Particular', 'Autorell'],
      imageAlt: 'Flujo de creación de anuncios de Autorell en un iPhone',
      seoTitle: 'Crear anuncio de vehículo gratis | Vender en Autorell',
      metaDescription: 'Crea un anuncio de vehículo gratis en Autorell. Paga solo si quieres más tiempo o visibilidad adicional.',
    },
    it: {
      title: 'Crea gratis un annuncio veicolo: paga solo se vuoi più tempo',
      excerpt: 'Autorell rende semplice iniziare. Pubblica gratis e scegli più visibilità solo quando serve.',
      body: [
        ['heading', 2, 'Un inizio più semplice per vendere un veicolo'],
        ['paragraph', 1, 'Vendere un veicolo non dovrebbe iniziare con vincoli, costi nascosti o passaggi complicati. Su Autorell i privati possono creare un annuncio gratuito in pochi minuti.'],
        ['paragraph', 1, 'Inserisci i dati principali, carica foto chiare e pubblica quando tutto è pronto.'],
        ['heading', 2, 'Paga solo se vuoi pubblicare più a lungo'],
        ['paragraph', 1, 'L’annuncio gratuito ti aiuta a iniziare rapidamente. Se vuoi più durata o più visibilità, puoi scegliere un pacchetto a pagamento.'],
        ['paragraph', 1, 'Paghi per tempo ed esposizione extra, non per essere presente sulla piattaforma.'],
        ['heading', 2, 'Pensato per il mobile'],
        ['paragraph', 1, 'Autorell guida il flusso: categoria, dati di base, dettagli tecnici, immagini, anteprima e pubblicazione.'],
        ['paragraph', 1, 'Marca, modello, luogo, prezzo e immagini chiare rendono l’annuncio più facile da trovare e più credibile.'],
      ],
      tags: ['Annuncio gratuito', 'Vendere veicolo', 'Privato', 'Autorell'],
      imageAlt: 'Flusso di creazione annuncio Autorell su iPhone',
      seoTitle: 'Crea un annuncio veicolo gratis | Vendi su Autorell',
      metaDescription: 'Crea gratis un annuncio veicolo su Autorell. Paga solo per maggiore durata o visibilità.',
    },
    nl: {
      title: 'Maak gratis een voertuigadvertentie: betaal alleen voor extra looptijd',
      excerpt: 'Autorell maakt starten eenvoudig. Publiceer gratis en kies extra zichtbaarheid alleen wanneer je die nodig hebt.',
      body: [
        ['heading', 2, 'Een eenvoudigere start voor voertuigverkoop'],
        ['paragraph', 1, 'Een voertuig verkopen moet niet beginnen met gedoe, verplichtingen of verborgen kosten. Op Autorell kunnen particuliere verkopers gratis een advertentie maken.'],
        ['paragraph', 1, 'Voeg de belangrijkste gegevens toe, upload duidelijke foto’s en publiceer wanneer alles klopt.'],
        ['heading', 2, 'Betaal alleen als je langer wilt adverteren'],
        ['paragraph', 1, 'De gratis advertentie helpt je snel te starten. Voor een langere looptijd of meer zichtbaarheid kun je een betaald pakket kiezen.'],
        ['paragraph', 1, 'Je betaalt voor extra tijd en bereik, niet om vanaf het begin mee te doen.'],
        ['heading', 2, 'Vanaf de eerste stap mobiel gebouwd'],
        ['paragraph', 1, 'Autorell begeleidt je door categorie, basisinformatie, technische details, afbeeldingen, preview en publicatie.'],
        ['paragraph', 1, 'Merk, model, locatie, prijs en duidelijke foto’s maken de advertentie beter vindbaar en betrouwbaarder.'],
      ],
      tags: ['Gratis advertentie', 'Voertuig verkopen', 'Particulier', 'Autorell'],
      imageAlt: 'Autorell advertentieflow op een iPhone',
      seoTitle: 'Gratis voertuigadvertentie maken | Verkopen op Autorell',
      metaDescription: 'Maak gratis een voertuigadvertentie op Autorell. Betaal alleen voor extra looptijd of zichtbaarheid.',
    },
    pl: {
      title: 'Dodaj ogłoszenie pojazdu za darmo: płać tylko za dłuższy czas',
      excerpt: 'Autorell ułatwia start. Publikuj bezpłatnie i wybieraj dodatkową widoczność tylko wtedy, gdy jej potrzebujesz.',
      body: [
        ['heading', 2, 'Prostszy start sprzedaży pojazdu'],
        ['paragraph', 1, 'Sprzedaż pojazdu nie powinna zaczynać się od ukrytych kosztów ani skomplikowanego procesu. W Autorell prywatni sprzedawcy mogą dodać ogłoszenie za darmo.'],
        ['paragraph', 1, 'Uzupełnij najważniejsze dane, dodaj wyraźne zdjęcia i opublikuj ogłoszenie, gdy wszystko jest gotowe.'],
        ['heading', 2, 'Płać tylko wtedy, gdy chcesz ogłaszać dłużej'],
        ['paragraph', 1, 'Bezpłatne ogłoszenie pomaga szybko rozpocząć sprzedaż. Jeśli chcesz dłuższy czas emisji lub większą widoczność, możesz wybrać płatny pakiet.'],
        ['paragraph', 1, 'Płacisz za dodatkowy czas i ekspozycję, a nie za samą obecność na rynku.'],
        ['heading', 2, 'Zaprojektowane z myślą o telefonie'],
        ['paragraph', 1, 'Autorell prowadzi przez kategorię, dane podstawowe, szczegóły techniczne, zdjęcia, podgląd i publikację.'],
        ['paragraph', 1, 'Marka, model, lokalizacja, cena i dobre zdjęcia pomagają kupującym znaleźć i ocenić ogłoszenie.'],
      ],
      tags: ['Darmowe ogłoszenie', 'Sprzedaż pojazdu', 'Sprzedawca prywatny', 'Autorell'],
      imageAlt: 'Proces dodawania ogłoszenia Autorell na iPhonie',
      seoTitle: 'Dodaj ogłoszenie pojazdu za darmo | Sprzedawaj na Autorell',
      metaDescription: 'Dodaj ogłoszenie pojazdu za darmo w Autorell. Płać tylko za dłuższy czas emisji lub dodatkową widoczność.',
    },
    da: {
      title: 'Opret en køretøjsannonce gratis: betal kun for længere tid',
      excerpt: 'Autorell gør det nemt at komme i gang. Publicer gratis og vælg ekstra synlighed først, når du har brug for det.',
      body: [
        ['heading', 2, 'En nemmere start, når du vil sælge et køretøj'],
        ['paragraph', 1, 'At sælge et køretøj bør ikke starte med besvær, binding eller skjulte gebyrer. På Autorell kan private sælgere oprette en annonce gratis på få minutter.'],
        ['paragraph', 1, 'Udfyld de vigtigste oplysninger, upload tydelige billeder og publicer, når alt er klar.'],
        ['heading', 2, 'Betal kun hvis du vil annoncere længere'],
        ['paragraph', 1, 'Den gratis annonce hjælper dig hurtigt i gang. Hvis du ønsker længere varighed eller mere synlighed, kan du vælge en betalt pakke.'],
        ['paragraph', 1, 'Du betaler for ekstra tid og eksponering, ikke for at være med fra start.'],
        ['heading', 2, 'Bygget til mobil fra første trin'],
        ['paragraph', 1, 'Autorell guider dig gennem kategori, basisdata, tekniske detaljer, billeder, forhåndsvisning og publicering.'],
        ['paragraph', 1, 'Mærke, model, placering, pris og klare billeder gør annoncen lettere at finde og mere troværdig.'],
      ],
      tags: ['Gratis annonce', 'Sælg køretøj', 'Privat sælger', 'Autorell'],
      imageAlt: 'Autorells annonceflow vist på en iPhone',
      seoTitle: 'Opret køretøjsannonce gratis | Sælg på Autorell',
      metaDescription: 'Opret en køretøjsannonce gratis på Autorell. Betal kun for længere varighed eller ekstra synlighed.',
    },
    fi: {
      title: 'Luo ajoneuvoilmoitus ilmaiseksi: maksa vain lisäajasta',
      excerpt: 'Autorell tekee aloittamisesta helppoa. Julkaise ilmaiseksi ja valitse lisänäkyvyys vasta tarvittaessa.',
      body: [
        ['heading', 2, 'Helpompi alku ajoneuvon myyntiin'],
        ['paragraph', 1, 'Ajoneuvon myynnin ei pitäisi alkaa piilokuluilla, sitoumuksilla tai hankalalla prosessilla. Autorellissa yksityiset myyjät voivat luoda ilmoituksen ilmaiseksi.'],
        ['paragraph', 1, 'Lisää tärkeimmät tiedot, lataa selkeät kuvat ja julkaise, kun kaikki on valmista.'],
        ['heading', 2, 'Maksa vain, jos haluat ilmoittaa pidempään'],
        ['paragraph', 1, 'Ilmainen ilmoitus auttaa pääsemään nopeasti alkuun. Jos haluat pidemmän ilmoitusajan tai enemmän näkyvyyttä, voit valita maksullisen paketin.'],
        ['paragraph', 1, 'Maksat lisäajasta ja näkyvyydestä, et siitä että pääset mukaan markkinapaikalle.'],
        ['heading', 2, 'Suunniteltu mobiiliin alusta alkaen'],
        ['paragraph', 1, 'Autorell ohjaa vaiheet: kategoria, perustiedot, tekniset tiedot, kuvat, esikatselu ja julkaisu.'],
        ['paragraph', 1, 'Merkki, malli, sijainti, hinta ja selkeät kuvat tekevät ilmoituksesta helpommin löydettävän ja luotettavamman.'],
      ],
      tags: ['Ilmainen ilmoitus', 'Myy ajoneuvo', 'Yksityinen myyjä', 'Autorell'],
      imageAlt: 'Autorellin ilmoitusprosessi iPhonessa',
      seoTitle: 'Luo ajoneuvoilmoitus ilmaiseksi | Myy Autorellissa',
      metaDescription: 'Luo ajoneuvoilmoitus ilmaiseksi Autorellissa. Maksa vain pidemmästä ilmoitusajasta tai lisänäkyvyydestä.',
    },
  },
