...
export function isSeoVehiclePath(market: string, segments: string[]) {
  ...
  if (!categorySegment) return false
  if (isSeoMarketCode(market) && getSeoCategoryBySegment(market, categorySegment)) return true
...
const geoMarketplaceCategorySegmentsByMarket: Record<string, Set<string>> = {
  se: new Set([
    ...
    'cyklar',
    'leasingbilar',
    'leasingtransportbilar',
    'leasinglastbilar',
    'leasinglantbruksmaskiner',
    'leasingentreprenadmaskiner',
  ]),
  de: new Set([
    'autos',
    'transporter',
  ...
  fr: new Set([
    ...
    'leasing-utilitaires',
    'leasing-camions',
    'leasing-machines-agricoles',
    'leasing-engins-chantier',
  ]),
  it: new Set([
    'auto',
    'furgoni',
    ...
    'leasing-furgoni',
    'leasing-autocarri',
    'leasing-macchine-agricole',
    'leasing-macchine-edili',
  ]),
  es: new Set([
    'coches',
    'furgonetas',
    ...
    'leasing-furgonetas',
    'leasing-camiones',
    'leasing-maquinaria-agricola',
    'leasing-maquinaria-construccion',
  ]),
  nl: new Set([
    'autos',
    'bestelwagens',
  ...
  pl: new Set([
    ...
    'leasing-dostawcze',
    'leasing-ciezarowki',
    'leasing-maszyny-rolnicze',
    'leasing-maszyny-budowlane',
  ]),
  dk: new Set([
    'biler',
    'varevogne',
    ...
    'leasingvarevogne',
    'leasinglastbiler',
    'leasinglandbrugsmaskiner',
    'leasingentreprenormaskiner',
  ]),
  fi: new Set([
    'autot',
    'pakettiautot',
    ...
    'leasingautot',
    'leasingpakettiautot',
    'leasing-kuorma-autot',
    'leasingmaatalouskoneet',
    'leasingmaanrakennuskoneet',
  ]),
}
