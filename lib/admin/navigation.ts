...
export const ADMIN_NAVIGATION: AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Företagspiloter', href: '/admin/business-pilots', icon: 'companies', permission: 'business_pilots.read', available: true },
      { label: 'Lagerimporter', href: '/admin/inventory-imports', icon: 'listings', permission: 'inventory_imports.read', available: true },
  ...
  },
  {
    label: 'Innehåll',
    items: [
      { label: 'Innehåll & nyheter', href: '/admin/content', icon: 'content', permission: 'content.read', available: true },
      { label: 'Nyhetsbrev', href: '/admin/newsletters', icon: 'newsletter', permission: 'newsletters.read', available: true },
      { label: 'Media', href: '/admin/media', icon: 'media', permission: 'media.read', available: true },
    ],
  },
  {
    label: 'Plattform',
    items: [
      { label: 'Marknader & språk', href: '/admin/markets', icon: 'markets', permission: 'markets.read', available: true },
      { label: 'Fordonsdata', href: '/admin/vehicle-data', icon: 'vehicle', permission: 'vehicle_data.read', available: true },
      { label: 'Säkerhet', href: '/admin/security', icon: 'security', permission: 'security.read', available: true },
      { label: 'Statistik', href: '/admin/stats', icon: 'analytics', permission: 'analytics.read', available: true },
      { label: 'Systemstatus', href: '/admin/system', icon: 'system', permission: 'system.read', available: true },
