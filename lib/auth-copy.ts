...
const modalBase = {
  en: {
    ...
    confirmEmailSent: 'Open the email from Autorell and click the confirmation link. Your account is ready as soon as the email address is confirmed.',
    confirmEmailClose: 'I understand',
  ...
  sv: {
    ...
    confirmEmailTitle: 'Bekräfta din mejl för att fortsätta',
    confirmEmailSent: 'Öppna mejlet från Autorell och klicka på bekräftelselänken. Kontot är klart så snart mejladressen är bekräftad.',
    confirmEmailClose: 'Jag förstår',
  ...
  de: {
    ...
    confirmEmailTitle: 'Bestätigen Sie Ihre E-Mail, um fortzufahren',
    confirmEmailSent: 'Öffnen Sie die E-Mail von Autorell und klicken Sie auf den Bestätigungslink. Ihr Konto ist bereit, sobald die E-Mail-Adresse bestätigt wurde.',
    confirmEmailClose: 'Verstanden',
  ...
  fr: {
    ...
    confirmEmailSent: 'Ouvrez l’e-mail d’Autorell et cliquez sur le lien de confirmation. Votre compte est prêt dès que l’adresse e-mail est confirmée.',
    confirmEmailClose: 'J’ai compris',
  ...
  es: {
    ...
    confirmEmailSent: 'Abre el correo de Autorell y pulsa el enlace de confirmación. Tu cuenta estará lista en cuanto se confirme la dirección de correo.',
    confirmEmailClose: 'Entendido',
  ...
  it: {
    ...
    confirmEmailTitle: 'Conferma l’e-mail per continuare',
    confirmEmailSent: 'Apri l’e-mail di Autorell e seleziona il link di conferma. L’account sarà pronto non appena l’indirizzo e-mail sarà confermato.',
    confirmEmailClose: 'Ho capito',
  ...
  pl: {
    ...
    confirmEmailTitle: 'Potwierdź e-mail, aby kontynuować',
    confirmEmailSent: 'Otwórz wiadomość od Autorell i kliknij link potwierdzający. Konto będzie gotowe po potwierdzeniu adresu e-mail.',
    confirmEmailClose: 'Rozumiem',
  ...
  nl: {
    ...
    confirmEmailTitle: 'Bevestig je e-mail om verder te gaan',
    confirmEmailSent: 'Open de e-mail van Autorell en klik op de bevestigingslink. Je account is klaar zodra het e-mailadres is bevestigd.',
    confirmEmailClose: 'Begrepen',
    ...
    confirmEmailTitle: 'Vahvista sähköposti jatkaaksesi',
    confirmEmailSent: 'Avaa Autorellin lähettämä viesti ja napsauta vahvistuslinkkiä. Tilisi on valmis heti, kun sähköpostiosoite on vahvistettu.',
    confirmEmailClose: 'Ymmärrän',
  ...
  da: {
    ...
    confirmEmailTitle: 'Bekræft din e-mail for at fortsætte',
    confirmEmailSent: 'Åbn e-mailen fra Autorell, og klik på bekræftelseslinket. Din konto er klar, så snart e-mailadressen er bekræftet.',
    confirmEmailClose: 'Jeg forstår',
...
export function getLocalizedAuthModalCopy(locale: PublicLocale, mode: AuthMode, view: AuthView = mode): AuthModalCopy {
  ...
  return {
    ...
    confirmEmailTitle: source.confirmEmailTitle,
    confirmEmailSent: source.confirmEmailSent,
    confirmEmailClose: source.confirmEmailClose,
