...
test('marketplace mobile shortcuts use existing map, saved search and sorting controls', () => {
  ...
  assert.match(vehicleSearchExperienceSource, /calc\(20px\+max\(0px,var\(--autorell-mobile-browser-inset,0px\)-env\(safe-area-inset-bottom\)\)/)
...
test('mobile bottom navigation glass avoids white outlines and adapts inactive item contrast', () => {
  ...
  assert.match(publicHeaderSource, /calc\(20px\+max\(0px,var\(--autorell-mobile-browser-inset,0px\)-env\(safe-area-inset-bottom\)\)/)
