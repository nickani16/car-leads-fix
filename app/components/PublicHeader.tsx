  ...
  return (
    <>
      ...
      <nav
        ...
        className={`pointer-events-none fixed bottom-0 left-1/2 z-[120] -translate-x-1/2 transform-gpu pb-[var(--autorell-mobile-bottom-gap,calc(14px+max(0px,var(--autorell-mobile-browser-inset,0px)-env(safe-area-inset-bottom))))] transition-transform duration-300 min-[1120px]:hidden ${hideMobileBottomNav ? 'hidden' : ''} ${
