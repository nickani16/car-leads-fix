...
const existingPricingCopy: Partial<Record<PublicLocale, typeof copyByLocaleBase>> = {
  sv: {
    title: 'Annonspriser',
  ...
  pl: {
    title: 'Cennik',
    intro: 'Stałe ceny lokalne. Ta sama kwota jest widoczna przy płatności.',
    privateHeading: 'Ogłoszenia prywatne',
    addonsHeading: 'Usługi widoczności',
    ...
    standardText: '15 dni i rozszerzone statystyki ogłoszenia.',
    ...
    featured: 'Wyróżnione ogłoszenie',
    featuredText: 'Widoczne w specjalnych modułach i rekomendacjach.',
    refresh: 'Odnowienie',
    refreshText: 'Przesuwa ogłoszenie wyżej wśród zwykłych ogłoszeń bez zmiany daty utworzenia.',
    activeListings: 'aktywnych ogłoszeń',
    contactUs: 'Skontaktuj się',
    enterprise: 'Enterprise',
    sellCta: 'Dodaj ogłoszenie',
  },
}
...
type PricingCopy = typeof copyByLocaleBase

const germanPricingCopy: PricingCopy = {
  title: 'Anzeigenpreise',
  intro: 'Feste lokale Preise. Derselbe Betrag wird beim Bezahlen angezeigt.',
  privateHeading: 'Private Anzeigen',
  addonsHeading: 'Sichtbarkeitsoptionen',
  businessHeading: 'Firmenabonnements',
  category: 'Kategorie',
  start: 'Start',
  standard: 'Standard',
  premium: 'Premium',
  ...
  startText: '5 Tage, Standardplatzierung.',
  standardText: '15 Tage und erweiterte Anzeigenstatistik.',
  premiumText: '30 Tage, Premium-Badge und 7 Tage Topplatzierung.',
  topPlacement: 'Topplatzierung',
  topPlacementText: 'Gesponserte Platzierung in relevanten Suchergebnissen.',
  featured: 'Hervorgehobene Anzeige',
  featuredText: 'Wird in besonderen Modulen und Empfehlungen angezeigt.',
  refresh: 'Auffrischen',
  refreshText: 'Verschiebt die Anzeige nach oben, ohne das Erstellungsdatum zu ändern.',
...
const dutchPricingCopy: PricingCopy = {
  title: 'Advertentieprijzen',
  intro: 'Vaste lokale prijzen. Hetzelfde bedrag wordt bij het afrekenen getoond.',
  privateHeading: 'Particuliere advertenties',
  addonsHeading: 'Zichtbaarheidsdiensten',
  businessHeading: 'Bedrijfsabonnementen',
  category: 'Categorie',
  start: 'Start',
  standard: 'Standaard',
  premium: 'Premium',
  ...
  startText: '5 dagen, standaardplaatsing.',
  standardText: '15 dagen en uitgebreide advertentiestatistieken.',
  premiumText: '30 dagen, Premium-badge en 7 dagen toppositie.',
  topPlacement: 'Toppositie',
  topPlacementText: 'Gesponsorde plaatsing in relevante zoekresultaten.',
  featured: 'Uitgelichte advertentie',
  featuredText: 'Wordt weergegeven in speciale modules en aanbevelingen.',
  refresh: 'Vernieuwen',
  refreshText: 'Verplaatst de advertentie omhoog zonder de aanmaakdatum te wijzigen.',
  activeListings: 'actieve advertenties',
  contactUs: 'Contact opnemen',
  enterprise: 'Enterprise',
  sellCta: 'Advertentie plaatsen',
}

const copyByLocale: Record<PublicLocale, PricingCopy> = {
  sv: existingPricingCopy.sv!,
  en: copyByLocaleBase,
  de: germanPricingCopy,
  at: germanPricingCopy,
  be: dutchPricingCopy,
  fr: {
    title: 'Tarifs des annonces',
    intro: 'Tarifs locaux fixes. Le même montant est affiché lors du paiement.',
    privateHeading: 'Annonces de particuliers',
    addonsHeading: 'Services de visibilité',
    businessHeading: 'Abonnements professionnels',
    category: 'Catégorie',
    start: 'Start',
    standard: 'Standard',
    premium: 'Premium',
    ...
    startText: '5 jours, placement standard.',
    standardText: '15 jours et statistiques détaillées de l’annonce.',
    premiumText: '30 jours, badge Premium et placement prioritaire pendant 7 jours.',
    topPlacement: 'Placement prioritaire',
    topPlacementText: 'Placement sponsorisé dans les résultats de recherche pertinents.',
    featured: 'Annonce à la une',
    featuredText: 'Affichée dans des modules spéciaux et des recommandations.',
    refresh: 'Remonter l’annonce',
    refreshText: 'Remonte l’annonce sans modifier sa date de création.',
    activeListings: 'annonces actives',
    contactUs: 'Nous contacter',
    enterprise: 'Enterprise',
    sellCta: 'Créer une annonce',
  },
  es: {
    title: 'Precios de anuncios',
    intro: 'Precios locales fijos. Se muestra el mismo importe al pagar.',
    privateHeading: 'Anuncios particulares',
    addonsHeading: 'Servicios de visibilidad',
    businessHeading: 'Suscripciones para empresas',
    category: 'Categoría',
    start: 'Start',
    standard: 'Estándar',
    premium: 'Premium',
    ...
    startText: '5 días, posición estándar.',
    standardText: '15 días y estadísticas ampliadas del anuncio.',
    premiumText: '30 días, distintivo Premium y 7 días de posición destacada.',
    topPlacement: 'Posición destacada',
    topPlacementText: 'Posición patrocinada en resultados de búsqueda relevantes.',
    featured: 'Anuncio destacado',
    featuredText: 'Se muestra en módulos especiales y recomendaciones.',
    refresh: 'Renovar',
    refreshText: 'Sube el anuncio sin cambiar su fecha de creación.',
    activeListings: 'anuncios activos',
    contactUs: 'Contactar',
    enterprise: 'Enterprise',
    sellCta: 'Crear anuncio',
  },
  it: {
    title: 'Prezzi degli annunci',
    intro: 'Prezzi locali fissi. Lo stesso importo viene mostrato al pagamento.',
    privateHeading: 'Annunci privati',
    addonsHeading: 'Servizi di visibilità',
    businessHeading: 'Abbonamenti aziendali',
    category: 'Categoria',
    start: 'Start',
    standard: 'Standard',
    premium: 'Premium',
    ...
    startText: '5 giorni, posizione standard.',
    standardText: '15 giorni e statistiche estese dell’annuncio.',
    premiumText: '30 giorni, badge Premium e 7 giorni di posizione prioritaria.',
    topPlacement: 'Posizione prioritaria',
    topPlacementText: 'Posizione sponsorizzata nei risultati di ricerca pertinenti.',
    featured: 'Annuncio in evidenza',
    featuredText: 'Mostrato in moduli speciali e nelle raccomandazioni.',
    refresh: 'Rinnova',
    refreshText: 'Sposta l’annuncio più in alto senza modificarne la data di creazione.',
    activeListings: 'annunci attivi',
    contactUs: 'Contattaci',
    enterprise: 'Enterprise',
    sellCta: 'Crea annuncio',
  },
  pl: existingPricingCopy.pl!,
  nl: dutchPricingCopy,
  fi: {
    title: 'Ilmoitushinnat',
    intro: 'Kiinteät paikalliset hinnat. Sama summa näytetään kassalla.',
    privateHeading: 'Yksityiset ilmoitukset',
    addonsHeading: 'Näkyvyyspalvelut',
    businessHeading: 'Yritystilaukset',
    category: 'Luokka',
    start: 'Start',
    standard: 'Standard',
    premium: 'Premium',
    ...
    startText: '5 päivää, vakiopaikka.',
    standardText: '15 päivää ja laajennetut ilmoitustilastot.',
    premiumText: '30 päivää, Premium-merkintä ja 7 päivää kärkisijoitusta.',
    topPlacement: 'Kärkisijoitus',
    topPlacementText: 'Sponsoroitu sijoitus olennaisissa hakutuloksissa.',
    featured: 'Korostettu ilmoitus',
    featuredText: 'Näytetään erityisissä moduuleissa ja suosituksissa.',
    refresh: 'Uudista',
    refreshText: 'Nostaa ilmoitusta muuttamatta sen luontipäivää.',
    activeListings: 'aktiivista ilmoitusta',
    contactUs: 'Ota yhteyttä',
    enterprise: 'Enterprise',
    sellCta: 'Luo ilmoitus',
  },
  da: existingPricingCopy.da!,
}
