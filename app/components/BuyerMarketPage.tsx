...
const content = {
  de: {
    ...
    intro:
      'Autorell testet schwedische Fahrzeuge anonym im europäischen Käufernetzwerk, kauft ausgewählte Fahrzeuge selbst ein und verkauft sie als Handelspartner an den bestätigten Käufer weiter.',
...
const dealerExperienceContent = {
  de: {
    tiles: [
      ...
      {
        title: 'Gebotssystem',
        label: 'Einfaches Gebotsverfahren',
        text: 'Gebot, Gebühren und Gesamtsumme klar prüfen, bevor Sie absenden.',
        href: '/so-funktionierts',
        src: '/dealer-samsung.webp',
        alt: 'Autorell einfaches Gebotssystem mit Gebotsansicht und Kaufsumme',
      },
    ],
  },
  en: {
        ...
        <div className="relative mx-auto grid min-h-[820px] w-full max-w-[1440px] items-start gap-9 px-5 pb-12 pt-14 sm:min-h-[780px] sm:px-8 sm:py-20 lg:min-h-[760px] lg:grid-cols-[1.1fr_.62fr] lg:items-center lg:gap-16 lg:px-12 lg:py-24 xl:px-16">
          <div className="relative z-10 min-w-0 max-w-[760px] lg:translate-y-20 xl:translate-y-16">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                {t.primary}
                <span className="grid h-9 w-9 place-items-center rounded-full bg-white text-[#242424] transition group-hover:translate-x-0.5">
