...
const infoPageCopy = {
  en: {
    ...
    'safety-tips': {
      ...
      sections: [
        {
          title: 'Compare the vehicle and price',
          text: 'Compare similar vehicles and be cautious when a price is unusually low or the seller pressures you to decide quickly.',
        },
        {
          title: 'Verify the seller',
          text: 'Confirm the seller’s identity, address and contact details. Keep conversations connected to the listing and avoid unexplained third parties.',
        },
        {
          title: 'Inspect the vehicle',
          text: 'Inspect the vehicle in person or through an independent specialist. Match the VIN, mileage and condition with the advertisement.',
        },
        {
          title: 'Check documents and history',
          text: 'Review registration, ownership, service, inspection and finance information before agreeing to buy.',
        },
        {
          title: 'Use a traceable payment',
          text: 'Agree the recipient, amount and handover terms in writing. Never send money to a changed account without verifying it independently.',
        },
        {
          title: 'Pause and report concerns',
          text: 'If something feels wrong, stop the transaction, preserve messages and payment references, and report the listing to Autorell.',
        },
      ],
  ...
  sv: {
    ...
    'safety-tips': {
      ...
      eyebrow: 'Säkerhet',
      title: 'Tryggare fordonsaffärer börjar med bättre kontroller.',
      intro: 'Autorell uppmuntrar köpare och säljare att verifiera identitet, dokument, betalning och överlämning innan de går vidare.',
      primaryCta: 'Rapportera problem',
      secondaryCta: 'Köpguide',
      highlights: ['Verifiera identitet', 'Spara underlag', 'Undvik stressad betalning'],
      sections: [
        { title: 'Jämför fordon och pris', text: 'Jämför liknande fordon och var försiktig om priset är ovanligt lågt eller säljaren pressar dig att bestämma snabbt.' },
        { title: 'Verifiera säljaren', text: 'Kontrollera säljarens identitet, adress och kontaktuppgifter. Undvik oförklarade tredje parter.' },
        { title: 'Inspektera fordonet', text: 'Inspektera fordonet på plats eller via en oberoende specialist. Jämför chassinummer, mätarställning och skick med annonsen.' },
        { title: 'Kontrollera dokument och historik', text: 'Granska registrering, ägarskap, service, besiktning och finansiering innan du går vidare.' },
        { title: 'Använd spårbar betalning', text: 'Bekräfta mottagare, belopp och överlämningsvillkor skriftligt. Verifiera alltid ändrade kontouppgifter separat.' },
        { title: 'Pausa och rapportera', text: 'Om något känns fel ska du stoppa affären, spara meddelanden och betalningsreferenser och rapportera annonsen till Autorell.' },
      ],
      finalTitle: 'Förtroende byggs i detaljer',
      finalText: 'Noggrann dokumentation skyddar seriösa köpare, säljare och marknadsplatsen.',
    },
    payments: {
