...
export default function PublicBreadcrumbs({
  ...
  return (
    ...
    >
      <Link
        href="/"
        className="hidden shrink-0 rounded-full px-3 py-1.5 font-medium text-[#52636b] transition hover:bg-white hover:text-[#202124] sm:block"
      >
        Autorell
      </Link>
          ...
          >
            ...
            {item.href && !current ? (
              <Link
                href={item.href}
                title={item.label}
                className="block min-w-0 truncate rounded-full px-2 py-1.5 transition hover:bg-white hover:text-[#202124] sm:px-3"
              >
                {item.label}
              </Link>
            ) : (
              <span
                ...
                title={item.label}
                className="block min-w-0 truncate rounded-full bg-[#eaf4f8] px-2 py-1.5 font-medium text-[#314852] sm:px-3"
              >
                {item.label}
              </span>
            )}
