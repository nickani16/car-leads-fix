...
function savedSearchesClientCopy(locale: PublicLocale) {
  ...
  const copy: Record<PublicLocale, typeof en> = {
    ...
    be: {
      ...
      frequencyOff: 'Uit',
      frequencyDaily: 'Dagelijks overzicht',
      frequencyInstant: 'Direct',
      searchVehicles: 'Voertuigen zoeken',
      signInTitle: 'Meld u aan voor opgeslagen zoekopdrachten.',
      signInText: 'Opgeslagen zoekopdrachten zijn gekoppeld aan uw account zodat u later naar dezelfde filters kunt terugkeren.',
      emptyTitle: 'U hebt nog geen opgeslagen zoekopdrachten.',
      emptyText: 'Filter voertuigen op categorie, markt, prijs, brandstof, uitrusting en meer. Sla daarna de zoekopdracht op vanaf de zoekpagina.',
    },
    fr: {
      ...
      notifications: 'Notifications',
      frequencyOff: 'Désactivées',
      frequencyDaily: 'Résumé quotidien',
      frequencyInstant: 'Immédiat',
      searchVehicles: 'Rechercher des véhicules',
      signInTitle: 'Connectez-vous pour vos recherches enregistrées.',
      signInText: 'Les recherches enregistrées sont liées à votre compte afin que vous puissiez retrouver les mêmes filtres plus tard.',
      emptyTitle: 'Vous n’avez pas encore de recherches enregistrées.',
      emptyText: 'Filtrez les véhicules par catégorie, marché, prix, carburant, équipements et plus encore. Enregistrez ensuite la recherche depuis la page de recherche.',
    },
    es: {
      ...
      frequencyOff: 'Desactivadas',
      frequencyDaily: 'Resumen diario',
      frequencyInstant: 'Inmediata',
      searchVehicles: 'Buscar vehículos',
      signInTitle: 'Inicia sesión para ver tus búsquedas guardadas.',
      signInText: 'Las búsquedas guardadas están vinculadas a tu cuenta para que puedas volver a los mismos filtros más tarde.',
      emptyTitle: 'Aún no tienes búsquedas guardadas.',
      emptyText: 'Filtra vehículos por categoría, mercado, precio, combustible, equipamiento y más. Después guarda la búsqueda desde la página de búsqueda.',
    },
    it: {
      savedSearch: 'Ricerca salvata',
      updated: 'Aggiornato',
      open: 'Apri',
      delete: 'Elimina ricerca salvata',
      notifications: 'Notifiche',
      frequencyOff: 'Disattivate',
      frequencyDaily: 'Riepilogo giornaliero',
      frequencyInstant: 'Immediata',
      searchVehicles: 'Cerca veicoli',
      signInTitle: 'Accedi per vedere le ricerche salvate.',
      signInText: 'Le ricerche salvate sono collegate al tuo account così puoi tornare agli stessi filtri più tardi.',
      emptyTitle: 'Non hai ancora ricerche salvate.',
      emptyText: 'Filtra i veicoli per categoria, mercato, prezzo, carburante, dotazioni e altro. Poi salva la ricerca dalla pagina di ricerca.',
    },
    pl: {
      ...
      frequencyDaily: 'Dzienne podsumowanie',
      frequencyInstant: 'Natychmiast',
      searchVehicles: 'Szukaj pojazdów',
      signInTitle: 'Zaloguj się, aby zobaczyć zapisane wyszukiwania.',
      signInText: 'Zapisane wyszukiwania są połączone z Twoim kontem, aby można było wrócić do tych samych filtrów później.',
      emptyTitle: 'Nie masz jeszcze zapisanych wyszukiwań.',
      emptyText: 'Filtruj pojazdy według kategorii, rynku, ceny, paliwa, wyposażenia i innych parametrów. Następnie zapisz wyszukiwanie na stronie wyników.',
    },
    nl: {
      savedSearch: 'Opgeslagen zoekopdracht',
      updated: 'Bijgewerkt',
      ...
      frequencyOff: 'Pois',
      frequencyDaily: 'Päivittäinen yhteenveto',
      frequencyInstant: 'Heti',
      searchVehicles: 'Etsi ajoneuvoja',
      signInTitle: 'Kirjaudu sisään tallennettuja hakuja varten.',
      signInText: 'Tallennetut haut liitetään tiliisi, jotta voit palata samoihin suodattimiin myöhemmin.',
      emptyTitle: 'Sinulla ei ole vielä tallennettuja hakuja.',
      emptyText: 'Suodata ajoneuvoja luokan, markkinan, hinnan, käyttövoiman, varusteiden ja muiden tietojen mukaan. Tallenna haku hakusivulta.',
    },
    da: {
      ...
      frequencyOff: 'Fra',
      frequencyDaily: 'Dagligt sammendrag',
      frequencyInstant: 'Straks',
      searchVehicles: 'Søg køretøjer',
      signInTitle: 'Log ind for gemte søgninger.',
      signInText: 'Gemte søgninger er knyttet til din konto, så du kan vende tilbage til de samme filtre senere.',
      emptyTitle: 'Du har endnu ingen gemte søgninger.',
