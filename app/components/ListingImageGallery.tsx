        ...
        {displayImageCount > 1 ? (
          <>
            <button
              ...
              className="absolute left-3 top-1/2 z-10 grid h-9 w-9 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-[#101828] shadow-[0_2px_12px_rgba(16,24,40,.18)] backdrop-blur transition hover:bg-white sm:left-4 sm:h-10 sm:w-10"
            ...
            <button
              type="button"
              onClick={showNext}
              className="absolute right-3 top-1/2 z-10 grid h-9 w-9 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-[#101828] shadow-[0_2px_12px_rgba(16,24,40,.18)] backdrop-blur transition hover:bg-white sm:right-4 sm:h-10 sm:w-10"
