...
export default function MessageSellerButton({
  ...
  const buttonClass =
    variant === 'button'
      ? 'inline-flex min-h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-[9px] bg-[#0866ff] px-4 text-[13px] font-semibold text-white transition hover:bg-[#0057e6] disabled:cursor-not-allowed disabled:bg-[#c7d7f5]'
