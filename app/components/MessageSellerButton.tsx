...
export default function MessageSellerButton({
  ...
  const buttonClass =
    variant === 'button'
      ? 'inline-flex min-h-12 w-full cursor-pointer items-center justify-center gap-2 rounded-[14px] bg-[#0866ff] px-5 text-sm font-semibold text-white transition hover:bg-[#0057e6] disabled:cursor-not-allowed disabled:bg-[#c7d7f5]'
