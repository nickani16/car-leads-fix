...
export default function ReportForm() {
  ...
  return <form onSubmit={submit} className="rounded-[22px] border bg-white p-6 shadow-sm sm:p-8">
    ...
    <div className="mt-4 grid gap-4 sm:grid-cols-2">
      ...
      <label className="block"><span className="mb-2 block text-sm font-semibold">När hände det?</span><input name="occurredAt" type="datetime-local" className="h-12 w-full rounded-[14px] border px-4" /></label>
      <label className="block"><span className="mb-2 block text-sm font-semibold">Belopp</span><input name="amount" type="number" min="0" step="0.01" className="h-12 w-full rounded-[14px] border px-4" /></label>
      <label className="block"><span className="mb-2 block text-sm font-semibold">Valuta</span><select name="currency" defaultValue="EUR" className="h-12 w-full rounded-[14px] border bg-white px-4"><option>EUR</option><option>SEK</option><option>DKK</option><option>PLN</option><option>CZK</option><option>HUF</option><option>RON</option><option>BGN</option></select></label>
      <label className="block"><span className="mb-2 block text-sm font-semibold">Telefon för återkoppling</span><input name="contactPhone" type="tel" className="h-12 w-full rounded-[14px] border px-4" /></label>
    </div>
