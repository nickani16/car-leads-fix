...
export default function AdminSubscriptionsPage({ searchParams }: { searchParams: AdminSearchParams }) {
  return (
    <AdminResourcePage
      ...
      select="id,user_id,product_key,plan_key,market,currency,status,payment_status,manually_activated,active_listing_limit,cancel_at_period_end,current_period_end,payment_warning_at,grace_period_ends_at,created_at"
