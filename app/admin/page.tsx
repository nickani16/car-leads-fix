...
export default async function AdminDashboardPage({
  ...
  const metrics = [
    ...
    ...(canReadCompanies ? [{ label: 'Företag att verifiera', value: pendingCompanies.count, helper: 'Manuell kontroll', href: '/admin/companies', icon: Building2, tone: pendingCompanies.count ? 'amber' as const : 'green' as const }] : []),
