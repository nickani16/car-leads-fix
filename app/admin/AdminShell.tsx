...
const mobileNavigation = [
  ...
  { label: 'Private supply', href: '/admin/leads?type=private_bid', icon: FileText },
  { label: 'Dealer stock', href: '/admin/leads?type=dealer_marketplace', icon: Store },
...
const menuGroups = [
  {
    ...
    items: [
      ...
      {
        label: 'Private vehicle supply',
        text: 'Assess vehicles offered to Autorell by private sellers.',
        href: '/admin/leads?type=private_bid',
        icon: FileText,
      },
      {
        label: 'Dealer stock supply',
        text: 'Assess stock vehicles offered to Autorell by Swedish dealers.',
