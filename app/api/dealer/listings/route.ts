  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            'Complete the required information. Vehicles must be located in Sweden, be model year 2018 or newer and have no more than 10,000 km.',
        },
        { status: 400 }
      )
    }
