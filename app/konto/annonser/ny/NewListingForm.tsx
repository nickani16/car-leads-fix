    ...
    <section>
      ...
      <label className="flex min-h-44 cursor-pointer flex-col items-center justify-center rounded-[22px] border border-dashed border-[#a8b4c7] bg-[#fbfcff] p-6 text-center">
        ...
        <strong className="mt-3 font-semibold text-[#101828]">
          {processingImages ? copy.processingImages : copy.addImages}
        </strong>
      ...
      {images.length ? (
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {images.map((image, index) => (
            ...
            >
              <Image src={image.preview} alt="" width={720} height={540} unoptimized className="aspect-[4/3] w-full bg-black object-contain" />
  ...
  return (
    <section className="grid gap-6 lg:grid-cols-[1.05fr_.95fr]">
      ...
      <article className="overflow-hidden rounded-[24px] border border-[#d7deed] bg-white shadow-sm">
        {images[0] ? (
          <Image src={images[0].preview} alt="" width={720} height={540} unoptimized className="aspect-[4/3] w-full bg-black object-contain" />
        ) : (
          ...
          {images.length > 1 ? (
            <div className="mt-4 grid grid-cols-4 gap-2">
              {images.slice(1, 5).map((image) => (
                <Image key={image.id} src={image.preview} alt="" width={240} height={180} unoptimized className="aspect-[4/3] w-full rounded-[10px] bg-black object-contain" />
              ))}
            </div>
          ) : null}
        </div>
