...
const questions = [
  ...
  ['Annonser', 'Vilka typer av fordon kan jag annonsera?', 'Bilar, transportbilar, motorcyklar, husbilar, husvagnar, lastbilar, lantbruk, entreprenad och cyklar.'],
  ...
  ['Priser', 'Vad kostar en annons?', 'Fem dagar är gratis. Varje fordonskategori har ett fast pris för 15 dagar och Premium 30 dagar. Samma kategoripris gäller för privatpersoner och företag och visas alltid före betalning.'],
